...
show_ads: true
description: DragonFire must keep a focused spot on a vulnerable part of a moving target long enough for heat damage to matter.
hero_summary: DragonFire must keep a focused spot on a vulnerable part of a moving target long enough for heat damage to matter.
layout: default
...
title: The Seconds That Decide a Laser Kill
title_full: The Seconds That Decide a Laser Kill
display_title_short: Dwell Time
display_title: Dwell Time
heading_title: The Seconds That Decide a Laser Kill
page_heading_title: The Seconds That Decide a Laser Kill
source_count: 38
infographic_count: 3
planned_sections:
...
image: /assets/images/Directed_Ener_98f417_dragonfire_uk_273ef3_weather_line_73eaec_dragonfire_dw_17157c-Illustration-1-social.jpg
---
...
This helps explain why DragonFire trials have emphasised not only target destruction but also target tracking performance. An [engagement chain]({{ 'engagement-chain/' | relative_url }}) is only as strong as its ability to maintain accurate illumination from first detection through final target defeat. [Leonardo+2mbda-systems.com](https://uk.leonardo.com/en/news-and-stories-detail/-/detail/dragonfire-laser-weapon-trial)

## Fast Targets Make Every Second Count

Recent DragonFire trials have reportedly engaged drones travelling at speeds up to roughly 650 km/h and demonstrated high-precision tracking against aerial threats. Such demonstrations are significant because [high-speed]({{ '650-km-h/' | relative_url }}) targets compress the available dwell-time window. [des.mod.uk+2Tom's Hardware](https://des.mod.uk/boost-for-armed-forces-as-new-laser-weapon-takes-down-high-speed-drones/)
...
* Reach the damage threshold before the target exits the engagement opportunity. [GOV.UK](https://www.gov.uk/government/news/advanced-future-military-laser-achieves-uk-first)
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers beam behaviour and energy concentration fundamentals.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides understandable explanations of laser weapon challenges.</p>
        <div class="fr-book-actions">
