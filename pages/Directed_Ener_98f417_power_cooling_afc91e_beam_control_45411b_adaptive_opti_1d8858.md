...
show_ads: true
description: Adaptive optics can reshape a distorted beam so more energy arrives in the focused spot despite turbulence, haze and temperature gradients.
hero_summary: Adaptive optics can reshape a distorted beam so more energy arrives in the focused spot despite turbulence, haze and temperature gradients.
layout: default
...
- /engineering/
- /aim-point/
nav_short_title: Adaptive Optics
title: Can Lasers Beat Turbulent Air?
title_full: Can Lasers Beat Turbulent Air?
display_title_short: Adaptive Optics
display_title: Adaptive Optics
heading_title: Can Lasers Beat Turbulent Air?
page_heading_title: Can Lasers Beat Turbulent Air?
source_count: 37
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Tiny Beam Jitters Matter So Much
header:
  og_image: /assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-1-social.jpg
  preview_image: /assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-1.webp
image: /assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-3-dark.svg" | relative_url }}" alt="Adaptive Optics illustration 3" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/pb5_F4_Eod8" title="Rheinmetall Air Defence – Skynex truck-mounted engaging drone swarm" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=pb5_F4_Eod8" target="_blank" rel="noopener noreferrer">Rheinmetall Air Defence – Skynex truck-mounted engaging drone swarm</a></p><p class="youtube-embed-meta">Channel: Rheinmetall – Der integrierte Technologiekonzern</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=pb5_F4_Eod8" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=pb5_F4_Eod8">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-2-dark.svg" | relative_url }}" alt="Adaptive Optics illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_power_cooling_afc91e_beam_control_45411b_adaptive_opti_1d8858-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
3. **Deformable mirror** – changes shape many times per second to impose the corrective pattern onto the outgoing beam. [Photonics+2skoge.folk.ntnu.no](https://www.photonics.com/Articles/Adaptive_Optics_Taming_Atmospheric_Turbulence/a25129)

The deformable mirror is the defining feature. Rather than being rigid, it contains many controllable actuators that slightly warp the mirror surface. Even microscopic changes can significantly alter the optical wavefront. The system continuously measures atmospheric distortion and updates the mirror shape in real time. [skoge.folk.ntnu.no+2mza.com](https://skoge.folk.ntnu.no/prost/proceedings/acc04/Papers/0565_ThM18.1.pdf)

The goal is not merely to keep the beam pointed at the target. Tracking and pointing systems handle aim. Adaptive optics improves the quality of the beam itself, ensuring that more of the [laser power]({{ 'power-costs/' | relative_url }}) arrives inside the desired spot once it reaches the target. This distinction is crucial in directed-energy engagements because improved [beam quality]({{ 'beam-quality/' | relative_url }}) directly translates into higher irradiance and shorter dwell times for achieving a given effect. [Google Patents+2ResearchGate](https://patents.google.com/patent/US8218589B1/en)
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses turbulence, beam spreading, wavefront distortion, and propagation limits in the atmosphere.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains how adaptive optics measures and corrects wavefront errors caused by atmospheric turbulence.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides deeper coverage of adaptive-optics systems, correction limits, sensors, and deformable mirrors.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Places atmospheric distortion, beam control, and adaptive-optics challenges within the broader directed-energy weapon context.</p>
        <div class="fr-book-actions">
