...
show_ads: true
description: The wall-plug phrase points to a real design goal, but power storage, cooling and sustained firing still shape battlefield usefulness.
hero_summary: The wall-plug phrase points to a real design goal, but power storage, cooling and sustained firing still shape battlefield usefulness.
layout: default
...
- /thor/
- /deployment/
nav_short_title: Power Burden
title: What Does Wall Plug Power Really Prove
title_full: What Does Wall Plug Power Really Prove
display_title_short: Power Burden
display_title: Power Burden
heading_title: What Does Wall Plug Power Really Prove
page_heading_title: What Does Wall Plug Power Really Prove
source_count: 27
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Sensor Chain
  heading_title: Why the Microwave Is Only Half the System
date: '2026-06-19 15:26:22 '
header:
  og_image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_airbase_b37f07_thor_power_bu_e74f3b-Illustration-1-social.jpg
  preview_image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_airbase_b37f07_thor_power_bu_e74f3b-Illustration-1.webp
image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_airbase_b37f07_thor_power_bu_e74f3b-Illustration-1-social.jpg
---
...
The wall-plug claim therefore proves something specific: THOR was engineered to fit into existing military infrastructure more easily than many people expect from a directed-energy weapon. It does not prove that power [generation]({{ 'generation-ii/' | relative_url }}), [cooling]({{ 'cooling/' | relative_url }}) or endurance cease to matter.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides the operational context driving systems like THOR.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers practical system integration issues.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Cooling and heat management concepts parallel directed-energy hardware.</p>
        <div class="fr-book-actions">
