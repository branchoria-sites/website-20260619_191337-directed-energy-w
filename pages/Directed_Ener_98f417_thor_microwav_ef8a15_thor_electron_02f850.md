...
- Directed_Ener_98f417_thor_microwav_ef8a15_thor_electron_02f850_index
...
show_ads: true
description: Wide-area microwave effects could help against swarms, but they also raise hard questions about nearby radios, radars, vehicles, aircraft, and personnel.
hero_summary: Wide-area microwave effects could help against swarms, but they also raise hard questions about nearby radios, radars, vehicles, aircraft, and personnel.
layout: default
permalink: /safety-zones/
sidebar_expanded_urls:
- /directed-ener/
- /thor/
nav_short_title: Safety Zones
title: What Else Could THOR Affect?
title_full: What Else Could THOR Affect?
display_title_short: Safety Zones
display_title: Safety Zones
heading_title: What Else Could THOR Affect?
page_heading_title: What Else Could THOR Affect?
source_count: 57
infographic_count: 3
planned_sections:
- Why wide area effects need safety rules
- Risks to friendly electronics and operations
- How exclusion zones shape real use
...
image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_electron_02f850-Illustration-1-social.jpg
---
...
### Radios, Networks and Command Systems
...
* Operators positioned near the system.
* Maintenance personnel working around protected assets.
* Aircrew and ground crews operating in defended areas.
* Civilian workers who may be present on large military installations.
* Nearby electronic medical or monitoring equipment where relevant.
...
* **Pre-planned [firing sectors]({{ 'firing-sectors/' | relative_url }}):** Operators may have approved engagement directions that minimise exposure to friendly infrastructure.

<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **Protected equipment zones:** Critical communications and command systems may receive additional shielding or separation.
* **Coordination procedures:** Air operations, maintenance activities and microwave engagements must be synchronised.
* **Electromagnetic spectrum management:** Microwave weapons become part of the wider process used to manage radars, radios and electronic warfare systems.

</div>

These requirements help explain why high-power microwave systems are often described as promising against swarms yet operationally complex. The challenge is not merely generating enough energy to affect hostile drones; it is doing so while preserving friendly capabilities.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains the target set THOR is designed to affect.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains impacts on electronic systems.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers effects and implications of directed-energy systems.</p>
        <div class="fr-book-actions">
