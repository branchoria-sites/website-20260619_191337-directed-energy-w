...
show_ads: true
description: Microwave swarm defence can force commanders to choose between firing quickly and preserving friendly drones already in the hazard area.
hero_summary: Microwave swarm defence can force commanders to choose between firing quickly and preserving friendly drones already in the hazard area.
layout: default
...
- /electronics-risk/
- /friendly-drones/
nav_short_title: Clearance Calls
title: When Should Friendly Drones Get Out?
title_full: When Should Friendly Drones Get Out?
display_title_short: Clearance Calls
display_title: Clearance Calls
heading_title: When Should Friendly Drones Get Out?
page_heading_title: When Should Friendly Drones Get Out?
source_count: 42
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: Pulse Effects
  heading_title: What Happens Inside an Exposed Drone?
date: '2026-06-19 16:33:46 '
header:
  og_image: /assets/images/Directed_Ener_98f417_friendly_elec_5af6bb_friendly_dron_967543_friendly_dron_417ec6-Illustration-1-social.jpg
  preview_image: /assets/images/Directed_Ener_98f417_friendly_elec_5af6bb_friendly_dron_967543_friendly_dron_417ec6-Illustration-1.webp
image: /assets/images/Directed_Ener_98f417_friendly_elec_5af6bb_friendly_dron_967543_friendly_dron_417ec6-Illustration-1-social.jpg
---
...
The key question is not merely whether a hostile drone is present. It is whether the [battlefield]({{ 'battle-limits/' | relative_url }}) situation permits a temporary clearing of the microwave zone, or whether the threat is urgent enough that commanders accept the risk of losing friendly drones in order to protect higher-priority forces and infrastructure.
...
**Expected effectiveness of the microwave shot.** If commanders believe a single engagement can neutralise many hostile drones, accepting some [friendly risk]({{ 'friendly-risk/' | relative_url }}) may appear justified.

**Threat density.** Larger [swarms]({{ 'swarms/' | relative_url }}) generally increase pressure to engage quickly.

**Availability of alternatives.** If kinetic interceptors, electronic warfare systems, or [lasers]({{ 'lasers/' | relative_url }}) can address the threat without endangering friendly drones, commanders may choose those options instead.
