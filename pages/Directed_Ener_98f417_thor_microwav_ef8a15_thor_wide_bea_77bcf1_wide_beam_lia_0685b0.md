...
show_ads: true
description: The same broad effect that helps THOR against dense swarms can complicate selectivity, safety boundaries and friendly electronics protection.
hero_summary: The same broad effect that helps THOR against dense swarms can complicate selectivity, safety boundaries and friendly electronics protection.
layout: default
...
- /thor/
- /wide-beam/
nav_short_title: Beam Risks
title: When A Wide Beam Becomes A Problem
title_full: When A Wide Beam Becomes A Problem
display_title_short: Beam Risks
display_title: Beam Risks
heading_title: When A Wide Beam Becomes A Problem
page_heading_title: When A Wide Beam Becomes A Problem
source_count: 55
infographic_count: 3
planned_sections:
- Why spread out swarms reduce the payoff
- Selectivity limits near friendly electronics
- Why microwave defence still needs other layers
...
image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_wide_bea_77bcf1_wide_beam_lia_0685b0-Illustration-1-social.jpg
---
...
### Risks to Friendly Systems

The most obvious concern is interference with friendly electronics operating near the engagement area.
...
* Uncrewed aircraft operating on the defender's side.
* Networked command-and-control systems.
* Civilian electronic infrastructure located near defended facilities.
...
### Hardening Creates an Uneven Battlefield
...
* Some drones may fail immediately.
* Others may suffer degraded performance.
* Hardened systems may continue operating.
* Friendly electronics may need protection despite not being the intended target.

</div>

The result is an engagement environment that can be less predictable than a purely kinetic intercept.


<img src="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_wide_bea_77bcf1_wide_beam_lia_0685b0-Illustration-3-dark.svg" | relative_url }}" alt="Beam Risks illustration 3" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_wide_bea_77bcf1_wide_beam_lia_0685b0-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_wide_bea_77bcf1_wide_beam_lia_0685b0-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Microwave Defence Still Needs Other Layers

The limitations of wide-beam engagement help explain why military organisations increasingly discuss microwave weapons as one layer within a broader air-defence architecture rather than a complete solution.

A microwave system excels when numerous drones enter a defended zone simultaneously. Yet other threats may demand different tools:
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses interference, compatibility, shielding, and unintended effects.</p>
        <div class="fr-book-actions">
