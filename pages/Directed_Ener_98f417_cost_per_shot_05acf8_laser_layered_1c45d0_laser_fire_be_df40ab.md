...
show_ads: true
description: Laser engagements only help missile stocks when commanders can safely assign cheap drones to the beam before harder threats arrive.
hero_summary: Laser engagements only help missile stocks when commanders can safely assign cheap drones to the beam before harder threats arrive.
layout: default
...
- /shot-cost/
- /layered-defence/
nav_short_title: A Laser Should Fire Before A Missile Only When The...
title: When Should a Laser Fire First?
title_full: When Should a Laser Fire First?
display_title_short: A Laser Should Fire Before A Missile Only When The...
display_title: A Laser Should Fire Before A Missile Only When The...
heading_title: When Should a Laser Fire First?
page_heading_title: When Should a Laser Fire First?
source_count: 45
infographic_count: 3
planned_sections:
- What makes a drone a suitable laser target
- How threat queues shape missile decisions
- Where the fire first logic can fail
...
next_link:
  ...
  heading_title: Why Lasers Still Need Backup Weapons
header:
  og_image: /assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-1-social.jpg
  preview_image: /assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-1.webp
image: /assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-1-social.jpg
---
...
The key question is therefore not whether a laser can hit a target. It is whether engaging that target with a laser improves the overall allocation of defensive resources across the entire threat picture.
...
* The target is a drone rather than a high-performance missile.
* The drone is within [line of sight]({{ 'dwell-time/' | relative_url }}).
...
The most important function of a laser layer is to influence what happens later in the engagement sequence.
...
* How many missiles remain available.
* Whether more dangerous threats are expected later.
* Whether the laser can achieve a timely kill.
* Whether the target is consuming attention that should be focused elsewhere.
* Whether alternative layers such as guns or electronic warfare are available.

</div>

In this framework, a drone may be assigned to a laser not because it is easy to destroy, but because it is the least efficient use of a missile.


<img src="{{ "/assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-2-dark.svg" | relative_url }}" alt="A Laser Should Fire Before A Missile Only When The Target illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_cost_per_shot_05acf8_laser_layered_1c45d0_laser_fire_be_df40ab-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The Mechanism: Preserving Interceptors for Hard Targets
...
1. Assign routine drone targets to lasers when conditions permit.
2. Reserve missiles for targets beyond laser range or capability.
3. Keep a missile reserve for cruise missiles, aircraft, and higher-end threats.
4. Avoid spending premium interceptors on threats that lower-cost layers can handle.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/ZFZyXAh2z84" title="Explained: How Israel&#x27;s Iron Beam Laser Defence System Works" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=ZFZyXAh2z84" target="_blank" rel="noopener noreferrer">Explained: How Israel&#x27;s Iron Beam Laser Defence System Works</a></p><p class="youtube-embed-meta">Channel: NDTV</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=ZFZyXAh2z84" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=ZFZyXAh2z84">Open on YouTube</a></p></div></div></div>

## Where the Fire-First Logic Can Fail

The decision to let the laser engage first is not automatic. Several conditions can invalidate the logic.
...
A target initially classified as a routine drone may actually be a more dangerous system carrying reconnaissance sensors, electronic warfare payloads or precision munitions. If the consequences of allowing it to continue even briefly are unacceptable, commanders may bypass the laser layer and use a missile immediately.
