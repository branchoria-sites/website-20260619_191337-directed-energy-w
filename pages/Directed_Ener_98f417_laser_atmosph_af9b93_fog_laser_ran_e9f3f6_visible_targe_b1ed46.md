...
show_ads: true
description: A target can remain easy to see through fog while the laser no longer delivers enough concentrated energy to damage it.
hero_summary: A target can remain easy to see through fog while the laser no longer delivers enough concentrated energy to damage it.
layout: default
...
- /atmosphere/
- /fog-range/
nav_short_title: Visible Targets
title: Why Seeing a Target Is Not Enough
title_full: Why Seeing a Target Is Not Enough
display_title_short: Visible Targets
display_title: Visible Targets
heading_title: Why Seeing a Target Is Not Enough
page_heading_title: Why Seeing a Target Is Not Enough
source_count: 42
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Which Fog Hurts Laser Range Most?
header:
  og_image: /assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-1-social.jpg
  preview_image: /assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-1.webp
image: /assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-1-social.jpg
---
...
This distinction is one of the most important practical [limits]({{ 'limits/' | relative_url }}) on laser weapons. In foggy conditions, operators may still see and track a drone, missile, or aircraft, yet the beam arriving at the target may no longer exceed the damage threshold needed for a successful engagement. The result is a target that remains visible but survives.
...
1. Fog scatters and absorbs part of the outgoing beam.
2. Less power reaches the target.
3. The beam spot may become less concentrated.
4. Surface heating slows dramatically.
5. The target remains below its damage threshold.
...
<img src="{{ "/assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-2-dark.svg" | relative_url }}" alt="Visible Targets illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_laser_atmosph_af9b93_fog_laser_ran_e9f3f6_visible_targe_b1ed46-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Tracking Can Succeed After Lethality Fails
...
* [Tracking errors]({{ 'tracking-errors/' | relative_url }}) accumulate.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses energy delivery and target damage mechanisms.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how beam quality improvements differ from restoring lost energy.</p>
        <div class="fr-book-actions">
