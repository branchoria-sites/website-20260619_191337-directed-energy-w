...
show_ads: true
description: HELIOS matters most when Aegis can hand it a target track before a small drone becomes a harder engagement problem.
hero_summary: HELIOS matters most when Aegis can hand it a target track before a small drone becomes a harder engagement problem.
layout: default
...
- /helios/
- /aegis-link/
nav_short_title: Aegis Cueing
title: Why Target Cueing Matters More Than Beam Power
title_full: Why Target Cueing Matters More Than Beam Power
display_title_short: Aegis Cueing
display_title: Aegis Cueing
heading_title: Why Target Cueing Matters More Than Beam Power
page_heading_title: Why Target Cueing Matters More Than Beam Power
source_count: 35
infographic_count: 3
planned_sections:
- How Aegis builds the target picture
- Why small drones make detection the hard part
- What faster cueing changes in a laser engagement
...
image: /assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-1-social.jpg
---
...
## Why Target Cueing Matters More Than Beam Power
...
<img src="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-3-dark.svg" | relative_url }}" alt="Aegis Cueing illustration 3" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **Detection** – radar or other ship sensors identify a potential contact.
2. **Tracking and classification** – Aegis refines the target's position, course and behaviour while evaluating its threat level.

<img src="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-2-dark.svg" | relative_url }}" alt="Aegis Cueing illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_helios_lasers_773815_aegis_integra_4d4642_aegis_cueing_20203d-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
3. **Weapon assignment** – the combat system selects an appropriate response and passes targeting information to the chosen weapon. [Navy+2Missile Defense Advocacy Alliance](https://www.navy.mil/DesktopModules/ArticleCS/Print.aspx?Article=2166739&ModuleId=724&PortalId=1)

HELIOS benefits because it enters the process late rather than early. The laser is not required to perform wide-area surveillance. It can be directed toward a target that Aegis has already identified and tracked. Lockheed Martin has repeatedly highlighted HELIOS as an integrated weapon system that combines laser, surveillance and combat-system connectivity rather than functioning as an isolated directed-energy demonstrator. [Lockheed Martin](https://www.lockheedmartin.com/en-us/news/features/2021/more-than-a-laser-helios-is-an-integrated-weapon-system.html)

This distinction becomes especially important when facing numerous drones approaching from different directions.

## Why Small Drones Make Detection the Hard Part

[Counter-drone]({{ 'missile-savings/' | relative_url }}) warfare often appears to be a problem of destructive power, but detection and tracking are frequently the greater challenge.

Small unmanned aerial systems present weak radar signatures, can fly close to the sea surface and may be obscured by environmental clutter. Academic research on [drone detection]({{ 'drone-detection/' | relative_url }}) consistently identifies reliable detection, classification and tracking of small drones as a major technical difficulty, often requiring advanced recognition and tracking techniques. [arXiv](https://arxiv.org/abs/2307.10326)

For HELIOS, this means the critical question is not whether the beam can damage a drone once it is held on target. The more difficult question is whether the ship can maintain a sufficiently accurate track for long enough to place the beam precisely where it needs to be.

Aegis helps solve that problem by maintaining the broader tactical picture. The combat system's sensors continue updating the target track while HELIOS is being positioned. Instead of searching a large volume of sky, the laser's tracking system can focus on a much smaller area where the target is already expected to appear. This dramatically reduces acquisition time and improves the probability of maintaining continuous track. [Navy+2Missile Defense Advocacy Alliance](https://www.navy.mil/DesktopModules/ArticleCS/Print.aspx?Article=2166739&ModuleId=724&PortalId=1)

Against a single drone the time savings may be measured in seconds. Against multiple drones, those seconds can determine whether the ship engages threats sequentially or becomes overwhelmed by simultaneous targets.

## What Faster Cueing Changes in a Laser Engagement

Laser weapons differ from missiles because they generally require a sustained dwell time on the target. The beam must remain accurately focused on a vulnerable point long enough to heat, damage or disable it.

Every second spent searching for a target reduces the time available for engagement. Faster cueing changes the geometry of the fight in several ways:

* **Earlier acquisition** – HELIOS can begin fine tracking sooner because Aegis already knows where the target is.
* **More engagement time** – less search time means more dwell time available to achieve effects on the target.
* **Higher throughput** – the weapon can transition between multiple drones more quickly.
* **Better weapon allocation** – Aegis can reserve expensive missiles for more demanding threats while assigning drones to the laser. [Lockheed Martin+2Seapower](https://www.lockheedmartin.com/en-us/news/features/2021/more-than-a-laser-helios-is-an-integrated-weapon-system.html)

This is particularly relevant for counter-[drone defence]({{ 'drone-defence/' | relative_url }}), where the economic advantage of [lasers]({{ 'lasers/' | relative_url }}) comes from engaging relatively inexpensive targets without expending missiles. That advantage only materialises if the laser can receive target information quickly enough to keep pace with incoming threats.

Recent reporting on HELIOS testing aboard USS *Preble* indicates successful engagements against multiple drone targets during Navy counter-UAS demonstrations, illustrating the operational importance of rapid target tracking and engagement management rather than [laser power]({{ 'power-costs/' | relative_url }}) alone. [The War Zone+2TheDefenseWatch.com](https://www.twz.com/sea/uss-preble-used-helios-laser-to-zap-four-drones-in-expanding-testing)

## The Real Breakthrough: A Shorter Sensor-to-Shooter Chain

The most important contribution of Aegis cueing is that it compresses the time between detection and engagement. Naval combat systems are fundamentally information-processing systems: they gather sensor data, create tracks, prioritise threats and assign weapons. HELIOS becomes more useful when it can plug directly into that process.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for laser engagements after cueing.</p>
        <div class="fr-book-actions">
