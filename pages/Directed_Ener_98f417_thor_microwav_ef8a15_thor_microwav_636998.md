...
- Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998_index
...
show_ads: true
description: Public sources describe THOR's counter-electronic effect, but not the waveform, range, frequency, or drone failure modes needed for independent verification.
hero_summary: Public sources describe THOR's counter-electronic effect, but not the waveform, range, frequency, or drone failure modes needed for independent verification.
layout: default
permalink: /kill-effect/
sidebar_expanded_urls:
- /directed-ener/
- /thor/
nav_short_title: Kill Effect
title: How Do Microwaves Disable Drones?
title_full: How Do Microwaves Disable Drones?
display_title_short: Kill Effect
display_title: Kill Effect
heading_title: How Do Microwaves Disable Drones?
page_heading_title: How Do Microwaves Disable Drones?
source_count: 44
infographic_count: 3
planned_sections:
- Electromagnetic coupling into drone electronics
- Why different drones may fail differently
- What remains classified or undisclosed
...
image: /assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-1-social.jpg
---
...
As a result, outside observers can confirm that drones were affected during demonstrations, but they cannot easily determine whether [THOR]({{ 'thor/' | relative_url }}) causes permanent hardware damage, temporary electronic upset, software crashes, power-system failures, sensor disruption, or some combination of these effects. That gap between observed outcomes and disclosed mechanisms is the central reason the system's kill effect remains difficult to verify publicly.
...
* A drone may lose communications and enter a failsafe mode.
* A flight controller may reboot and recover seconds later.
* Sensors may become unreliable.
* Electronic speed controllers may malfunction.
* Semiconductor components may suffer permanent damage.
* Multiple systems may fail simultaneously, causing an immediate crash.

</div>

From a distance, many of these outcomes can look identical: a drone falls, lands, veers away, or stops responding. Public videos and photographs rarely provide enough forensic evidence to distinguish among them.
...
* Drone orientation relative to the emitter.
* Shielding and circuit design of the target.

</div>

Because these variables are undisclosed, independent researchers cannot reproduce THOR's claimed effects under controlled conditions. Even when high-power microwave theory is understood in general terms, the exact pathway from transmitted pulse to [drone failure]({{ 'failure-modes/' | relative_url }}) remains largely hidden.


<img src="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-2-dark.svg" | relative_url }}" alt="Kill Effect illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Different Drones May Fail Differently
...
* The specific drone models used.
* Whether they were modified test vehicles.
* The level of electromagnetic hardening present.
* The exact failure observed after exposure.
* Whether affected drones could be repaired and flown again.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/1ws8ZWMFmCw" title="Brooklyn Van Zandt - HIGH (Official Lyric Video)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=1ws8ZWMFmCw" target="_blank" rel="noopener noreferrer">Brooklyn Van Zandt - HIGH (Official Lyric Video)</a></p><p class="youtube-embed-meta">Channel: Brooklyn Van Zandt</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=1ws8ZWMFmCw" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=1ws8ZWMFmCw">Open on YouTube</a></p></div></div></div>

## Why Public Demonstrations Do Not Resolve the Question
...
* Flight-controller upset.
* Battery-management failure.
* Permanent semiconductor damage.
* Combined electronic failures.

</div>

Without access to telemetry, component inspections, laboratory analysis, or classified test reports, distinguishing among these possibilities is extremely difficult.

This challenge is compounded by the fact that many demonstrations are conducted under controlled test conditions. Public observers rarely know the exact engagement geometry, environmental conditions, target preparation, or instrumentation used to evaluate effects.


<img src="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-3-dark.svg" | relative_url }}" alt="Kill Effect illustration 3" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_thor_microwav_ef8a15_thor_microwav_636998-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What Remains Classified or Undisclosed

The strongest reason THOR's kill mechanism cannot be independently verified is that the most important technical information remains undisclosed.

AFRL publicly describes THOR as a counter-swarm high-power microwave weapon but does not provide the engineering details necessary for replication or independent effectiveness assessment. Public sources do not reveal:
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Places counter-drone technologies such as THOR into the wider drone warfare landscape.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers the broader field of directed-energy systems relevant to microwave weapons.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains electromagnetic effects on electronic systems, closely related to microwave drone defeat mechanisms.</p>
        <div class="fr-book-actions">
