...
- Directed_Ener_98f417_friendly_elec_5af6bb_friendly_elec_febf66_index
...
show_ads: true
description: Range trials are not enough unless the defender's own radios, vehicles, sensors and medical devices are tested in realistic field conditions.
hero_summary: Range trials are not enough unless the defender's own radios, vehicles, sensors and medical devices are tested in realistic field conditions.
layout: default
permalink: /field-testing/
sidebar_expanded_urls:
- /directed-ener/
- /electronics-risk/
nav_short_title: Field Testing
title: Why Safe on the Range May Fail in the Field
title_full: Why Safe on the Range May Fail in the Field
display_title_short: Field Testing
display_title: Field Testing
heading_title: Why Safe on the Range May Fail in the Field
page_heading_title: Why Safe on the Range May Fail in the Field
source_count: 30
infographic_count: 3
planned_sections:
- Why real environments differ from clean test ranges
...
image: /assets/images/Directed_Ener_98f417_friendly_elec_5af6bb_friendly_elec_febf66-Illustration-1-social.jpg
---
...
## Why Safe on the Range May Fail in the Field
...
## The Key Lesson from Existing Evidence
