...
show_ads: true
description: A ship laser may beat one drone at a time, but raids and decoys can turn its dwell-time requirement into an engagement bottleneck.
hero_summary: A ship laser may beat one drone at a time, but raids and decoys can turn its dwell-time requirement into an engagement bottleneck.
layout: default
...
- /helios/
- /threat-boundary/
nav_short_title: Swarm Limits
title: Can One Laser Stop a Drone Swarm?
title_full: Can One Laser Stop a Drone Swarm?
display_title_short: Swarm Limits
display_title: Swarm Limits
heading_title: Can One Laser Stop a Drone Swarm?
page_heading_title: Can One Laser Stop a Drone Swarm?
source_count: 53
infographic_count: 3
planned_sections:
- Why Lasers Usually Service Targets Sequentially
- How Decoys Consume the Engagement Timeline
- Why Wider Area Weapons Enter the Debate
...
image: /assets/images/Directed_Ener_98f417_helios_lasers_773815_threat_bounda_0b6cdc_drone_swarm_l_94cfd2-Illustration-1-social.jpg
---
...
1. Confirm the kill.
2. Acquire the next target.
3. Slew the beam director.
4. Establish stable tracking.
5. Begin a new dwell cycle.
...
## The Real Boundary Is Engagement Rate
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context on drone evolution, countermeasures, and the growing challenge posed by massed unmanned systems.</p>
        <div class="fr-book-actions">
