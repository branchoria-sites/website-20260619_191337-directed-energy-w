...
child_basenames:
- Directed_Ener_98f417_defensive_lay_f8da0e_sensor_chain_13add0_index
...
show_ads: true
description: The hardest part of a useful directed-energy layer may be finding, identifying, tracking and handing off small threats in time.
hero_summary: The hardest part of a useful directed-energy layer may be finding, identifying, tracking and handing off small threats in time.
layout: default
...
title: The Beam Is Only Half the Weapon
title_full: The Beam Is Only Half the Weapon
display_title_short: Sensor Chain
display_title: Sensor Chain
heading_title: The Beam Is Only Half the Weapon
page_heading_title: The Beam Is Only Half the Weapon
source_count: 43
infographic_count: 3
planned_sections:
...
image: /assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_sensor_chain_13add0-Illustration-1-social.jpg
---

## Introduction

A laser defence system is often described as a weapon that destroys targets with a beam of light. In practice, the beam is only the final link in a much longer chain. The real challenge is detecting a small, fast or [low-flying]({{ 'low-flying/' | relative_url }}) threat, determining that it is hostile, predicting where it will be seconds later, and keeping a precise track long enough for the laser to achieve its effect. If that sensor chain fails, even the most powerful laser becomes irrelevant.
...
<img src="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_sensor_chain_13add0-Illustration-2-dark.svg" | relative_url }}" alt="Sensor Chain illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_sensor_chain_13add0-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_sensor_chain_13add0-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Command-and-Control Handoffs When Time Runs Out
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/WvrKnZsQFEY" title="Raytheon Intelligence &amp; Space - High-Energy Lasers" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=WvrKnZsQFEY" target="_blank" rel="noopener noreferrer">Raytheon Intelligence &amp; Space - High-Energy Lasers</a></p><p class="youtube-embed-meta">Channel: Breaking Defense</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=WvrKnZsQFEY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=WvrKnZsQFEY">Open on YouTube</a></p></div></div></div>
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains target tracking and prediction.</p>
        <div class="fr-book-actions">
