...
show_ads: true
description: Fixed-site lasers work best when radars, command centres and prepared engagement zones turn the beam into one layer of a wider defence.
hero_summary: Fixed-site lasers work best when radars, command centres and prepared engagement zones turn the beam into one layer of a wider defence.
layout: default
...
- /defence-layer/
- /base-defence/
nav_short_title: Defence Network
title: Why A Laser Is Not The Whole Defence
title_full: Why A Laser Is Not The Whole Defence
display_title_short: Defence Network
display_title: Defence Network
heading_title: Why A Laser Is Not The Whole Defence
page_heading_title: Why A Laser Is Not The Whole Defence
source_count: 39
infographic_count: 3
planned_sections:
...
image: /assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-3-dark.svg" | relative_url }}" alt="Defence Network illustration 3" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
3. **[Sensor fusion]({{ 'sensor-fusion/' | relative_url }}).** Data from several sensors can be combined into a more accurate picture than any single sensor can provide.

<img src="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-2-dark.svg" | relative_url }}" alt="Defence Network illustration 2" data-theme-src-dark="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Directed_Ener_98f417_defensive_lay_f8da0e_fixed_base_la_4ef4d2_base_laser_de_3ea4ca-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
4. **Battle management.** Operators can coordinate multiple defensive assets without duplication or gaps in coverage. [Missile Defense Advocacy Alliance](https://www.missiledefenseadvocacy.org/integrated-battle-networks/command-and-control-c2-systems/)

These functions become increasingly important during [saturation]({{ 'saturation/' | relative_url }}) attacks. A laser may have a low cost per shot and theoretically deep "magazines", but it can only engage a limited number of targets at any given moment because each engagement requires tracking and dwell time on the target. Command networks help allocate threats across the entire defensive system so that lasers are not overwhelmed. [GAO+2YouTube](https://www.gao.gov/products/gao-23-106717)

The operational workflow used in integrated missile-defence systems illustrates the point. Detection, assessment, decision and engagement occur as a connected chain rather than as isolated actions. The laser occupies only the final stage of that process. [Missile Defense Advocacy Alliance](https://www.missiledefenseadvocacy.org/integrated-battle-networks/command-and-control-c2-systems/)
...
This layered approach provides resilience because each system compensates for another's limitations. Weather, atmospheric conditions and [line-of-sight]({{ 'dwell-time/' | relative_url }}) restrictions can reduce laser effectiveness. Missiles may be expensive to expend against low-cost drones. Guns have limited range and ammunition. Combining them creates a more robust defence than relying on any single technology. [National Defense Magazine+2EPC](https://www.nationaldefensemagazine.org/articles/2025/8/11/government-perspective-directed-energy-in-air-base-defense-can-save-the-arsenal)

Recent programmes demonstrate this philosophy. Israel's Iron Beam has been developed not as a replacement for Iron Dome, David's Sling or Arrow, but as an additional layer intended to complement those systems within a broader defensive network. Similarly, US Army laser efforts have been tied to wider air-defence and indirect-fire protection architectures rather than conceived as independent weapons. [Reuters+2Tom's Hardware](https://www.reuters.com/business/aerospace-defense/israeli-anti-missile-laser-system-iron-beam-ready-military-use-this-year-2025-09-17/)
...
A standalone laser would need to search for threats, classify them, decide on engagement priorities and conduct interceptions by itself. A networked laser can rely on dedicated sensors, command systems and supporting weapons to perform those tasks. The result is faster reaction, better situational awareness and more effective use of all defensive assets. [Missile Defense Advocacy Alliance+2Thales Group](https://www.missiledefenseadvocacy.org/integrated-battle-networks/command-and-control-c2-systems/)
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Places emerging technologies such as directed energy within the larger context of doctrine, organization, and combined defense systems.</p>
        <div class="fr-book-actions">
