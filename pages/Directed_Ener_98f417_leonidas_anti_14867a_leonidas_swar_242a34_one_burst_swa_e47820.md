...
show_ads: true
description: A single wide-area microwave engagement can make defending against clustered drones less like buying one interceptor per target.
hero_summary: A single wide-area microwave engagement can make defending against clustered drones less like buying one interceptor per target.
layout: default
permalink: /one-burst/
...
- When swarm geometry helps the defender
- How costs change after the system is fielded
...
image: /assets/images/Directed_Ener_98f417_leonidas_anti_14867a_leonidas_swar_242a34_one_burst_swa_e47820-Illustration-1-social.jpg
---
...
* Drones are concentrated in a relatively small volume of airspace.
* Multiple aircraft enter the microwave engagement zone simultaneously.
* The swarm's operational concept relies on mass rather than wide dispersal.
...
## Why one burst is not a guaranteed swarm killer
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly explores massed drone engagements.</p>
        <div class="fr-book-actions">
